#!/usr/bin/python
# RPi kits PCB version of LCD_all_functions_demo2.py runs through a large sequence of display functions
#     with 3 second gaps between each item
# On a 16×2 LCD, the rows are numbered 1 – 2, while the columns are numbered 0 – 15. 

# command to run this demo:  python3 /home/pi/RPi_maker_kit5/displays/LCD_1602_i2c_display/LCD_all_functions_demo.py

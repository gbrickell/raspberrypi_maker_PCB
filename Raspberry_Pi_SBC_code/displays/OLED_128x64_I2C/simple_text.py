#!/usr/bin/python
# RPi PCB version of simple_text.py
...
# command:  python3 ./RPi_maker_PCB5/displays/OLED_128x64_I2C/simple_text.py
...
draw.text((x, top+16), "2nd line of text",  font=font, fill=255)
draw.text((x, top+32), "3rd line of text",  font=font, fill=255)
draw.text((x, top+48), "4th line of text",  font=font, fill=255)

#!/usr/bin/python
# RPi kits PCB version of button_led_take_image.py - image taking routine using a button with RGB LED indicator
#
# command: python3 ./RPi_maker_kit5/image_taking/button_led_take_image.py
#
...
while len(image_subfolder) <= 5 or " " in image_subfolder :
    image_subfolder = input(" Enter sub-folder name - must be more than 5 characters and no spaces (CTRL C to stop? )") or "single_image_led_folder"
print (" ***************************************************************************")
print (" ")

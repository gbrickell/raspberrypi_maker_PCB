...
#
# command: python3 ./RPi_maker_kit5/image_taking/button_timer_take_image.py
#
...
print (" ")
print (" ***************************************************************************")
print (" All button timed images will be stored under ./RPi_maker_kit5/image_taking/ ")
...
try:    # this loop is not strictly necessary but it does allow the script to be easily stopped with CTRL-C
    while True:  # this is the loop that checks if a button is pressed and takes an image if it is
        ...
        # if for some reason new file/directory ownership becomes an issue
        # uncomment the lines below changing YOURUSERNAME to 'your user name' :-)
        # create a command string to make sure the new fileis 'owned' by YOURUSERNAME

#!/usr/bin/python
# RPi PCB version of button_timer_take_image.py - timer initiated image taking routine using a button with RGB LED + buzzer indicators
#
...
print (" ")
print (" **************************************************************************************************")
print (" All button timed images will be stored under /home/" + user_name + "/RPi_maker_PCB5/image_taking/ ")

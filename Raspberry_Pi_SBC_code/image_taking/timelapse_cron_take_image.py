...
#
# command: python3 ./RPi_maker_PCB5/image_taking/timelapse_cron_take_image.py
#
...
#*/5 * * * * python3 /home/userId/RPi_maker_PCB5/image_taking/timelapse_cron_take_annotated_image.py >> /dev/null 2>> /dev/null
# or
# script to run every 5 minutes from 6am through to 9:55pm (adjust time as necessary)
#*/5 6-21 * * * python3 /home/userId/RPi_maker_PCB5/image_taking/timelapse_cron_take_annotated_image.py >> /dev/null 2>> /dev/null

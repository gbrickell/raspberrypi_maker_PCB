#!/usr/bin/python
# button_take_video.py - simple video taking routine using a button
#
# command: python3 ./RPi_maker_PCB5/image_taking/button_take_video.py
#
...
try:    # this loop is not strictly necessary but it does allow the script to be easily stopped with CTRL-C
    while True:  # this is the loop that checks if a button is pressed and takes an image if it is
        ...
        print ("press button 2 to take a short video clip or type CTRL-C to stop the program")
        print (" ")
        ...
        # usb_device is determined earlier to set the -i parameter for where the USB camera is connected

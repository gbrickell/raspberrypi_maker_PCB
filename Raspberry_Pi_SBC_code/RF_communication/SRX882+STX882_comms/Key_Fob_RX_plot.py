...
# Command to run:  python3 /home/pi/RPi_maker_kit5/RF_communication/SRX882+STX882_comms/Key_Fob_RX_plot.py
...
MAX_DURATION = 5
RECEIVE_PIN = 18       # data pin on the SRX882 RF board
SET_MODE_PIN = 15      # CS pin on the SRX882 RF board

GPIO.setup(RECEIVE_PIN, GPIO.IN)
GPIO.setup(SET_MODE_PIN, GPIO.OUT)
# set mode to normal working
GPIO.output(SET_MODE_PIN, 1)
print("receiver mode pin set to 1")
time.sleep(2)  # pause for 2 seconds just so the LEDs can be seen
# 0.1 second beep x3 
beep(3, 0.1)
